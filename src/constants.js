//BRAND
export const name = 'Sarawati';
export const company = 'Casperjoe Team';
export const websiteURL = 'https://sarawati.deckabydeka.com/';
export const serverURL = 'http://localhost:5000';
export const logo = 'https://firebasestorage.googleapis.com/v0/b/saraswati-28465.appspot.com/o/logo512.png?alt=media&token=081ff516-5975-408b-be72-daf04391fad5';
